...
If you want to use `CacheLink` you should use `@UseCaseKey` decorator in all your use cases (queries and commands). To learn more about cache move to [cache section](#cache).
